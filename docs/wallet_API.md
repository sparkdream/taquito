...
The different types of events are defined in the type `BeaconEvent` that can be imported from `"@sparkdreamnft/beacon-sdk"`. Some of the events are: `ACTIVE_ACCOUNT_SET`, `PAIR_SUCCESS`, `SIGN_REQUEST_SUCCESS`.
